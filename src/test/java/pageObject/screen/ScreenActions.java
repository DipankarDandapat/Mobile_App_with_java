...
public class ScreenActions {
    ...
    protected boolean isElementDisplayed(MobileElement element, WaitStrategy waitStrategy) {
        return WaitFactory.explicitlyWaitForElement(waitStrategy, element).isDisplayed();
    }
