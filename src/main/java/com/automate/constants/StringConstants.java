...
public final class StringConstants {
    ...
    public static final String Credit_Check_Banner_TITLE = "Apply for a limit increasess";
    public static final String Credit_Check_Description="Share following information to get higher borrowing limit";
